...
const MainContent = () => {
  ...
  return (
    <main className="flex-1 px-4 sm:px-6 pt-6 pb-28 overflow-y-auto">
      <form
      ...
      >
        <input
          ...
          className="w-full bg-zinc-800 rounded-full px-6 py-3 pl-14 text-lg placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-rose-500"
        />
        <button
          type="submit"
